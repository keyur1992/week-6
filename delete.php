    ...
    <div class="light-bg">
      ...
      <div class="shell">
        ...
        <div class="header">
          ...
          <!-- end of socials -->
          <h1 id="logo"><a href="index.php">Moviereviews</a></h1>
          <!-- navigation -->
          <nav id="navigation">
            <ul>
              <li><a href="index.php">MOVIE REVIEWS</a></li>
              <li><a href="update.php">MOST COMMENTED REVIEW LIST</a></li>
              <li><a href="delete.php">DELETE MOVIE <span>20</span></a></li>
            </ul>
          </nav>
          <!-- end of navigation -->
          <div class="cl">&nbsp;</div>
          ...
          <section class="content">
            ...
            <div class="post">
              ...
              <div class="post-inner">
                <header>
                  <h2><a href="#">User Delete Recommendations</a></h2>
                  <div class="cl">&nbsp;</div>
                </header>
...
?> 
    ...
    &nbsp;          
<!-- form start -->
<form id="form1" name="form1" method="post" action="delete_process.php">
    	  <table> 
    	    <tr>
    	      <td>Movie Id:</td>
    	      <td><input name="movieid"  id="movieid" required="required"  />
          </td>
  	      </tr>
    	    <tr>
    	      <td>&nbsp;</td>
